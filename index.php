    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="images/logoabc.png" width="35" height="35" style="float:left;margin:0 8px 4px 0;" />Klinik ABC</a>
            </div>
...
?>
    ...
    <section>
        ...
        <div id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2023 <a href="javascript:void(0);">copyright by Anan Aulia Rahman</a>
                </div>
                <div class="version">
                    <b>Version: </b> 1.0
                </div>
